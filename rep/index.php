...
<div id="content">
  <h1>Welcome to Fundraising ATM!</h1>
  ...
  <div id="column2">
    ...
    <div id="pcaption">
      FundraisingATM offers fundraising opportunities for schools, religious organizations, community organizations and more. 
    </div>
    ...
    <div>
      <a href="gettingstarted_sendemail.php"><input type="button" class="redbutton" value="Let the Fundraising Begin!"/></a>
    </div>
  </div>    <!--end column2-->
</div>  <!--end content-->
