...
<ul class="dropdown-menu">
	<div id="dropdownrow" class= "row-fluid row-flex" >
        ...
        <!--<span class="col-flex-item divider"></span><li id="storename"><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Varsity A-Squad Sports Supply/c/18209625/offset=0&sort=priceAsc">Varsity A-Squad Sports Supply</a></li>
		    <ul>
		        ...
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Golf/c/18209631/offset=0&sort=priceAsc">Golf</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Hockey/c/18209632/offset=0&sort=priceAsc">Hockey</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Lacrosse/c/18209633/offset=0&sort=priceAsc">Lacrosse</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Soccer/c/18209634/offset=0&sort=priceAsc">Soccer</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Softball/c/18209635/offset=0&sort=priceAsc">Softball</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Track/c/18209636/offset=0&sort=priceAsc">Track</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Volleyball/c/18209637/offset=0&sort=priceAsc">Volleyball</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Coaches/c/18209638/offset=0&sort=priceAsc">Coaches</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Dance/c/18209639/offset=0&sort=priceAsc">Dance</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Accessories/c/18209640/offset=0&sort=priceAsc">Accessories</a></li>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=115#!/Fan Pack/c/18209641/offset=0&sort=priceAsc">Fan Pack</a></li>
			...
			<li id="storename"><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Athleisure/c/19393860/offset=0&sort=priceAsc">Athleisure</a></li>
				...
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Performance-Tops/c/19405350/offset=0&sort=priceAsc">Performance Tops</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Tank-Tops/c/19405351/offset=0&sort=priceAsc">	&nbsp;&nbsp;&nbsp;&nbsp;Tank Tops</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Crew-Necks/c/19405355/offset=0&sort=priceAsc">	&nbsp;&nbsp;&nbsp;&nbsp;Crew Neck</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/V-Necks/c/19405356/offset=0&sort=priceAsc">	&nbsp;&nbsp;&nbsp;&nbsp;V Necks</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/All-Colors/c/19405357/offset=0&sort=priceAsc">	&nbsp;&nbsp;&nbsp;&nbsp;All Colors</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Pants/c/19405349/offset=0&sort=priceAsc">Pants</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Sports-Bras/c/19405348/offset=0&sort=priceAsc">Sports Bras</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Yoga & Leggings/c/19405347/offset=0&sort=priceAsc">Yoga & Leggings</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Tanks/c/19405346/offset=0&sort=priceAsc">Tank Tops</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Sweatshirts/c/19405345/offset=0&sort=priceAsc">Sweatshirts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Jackets/c/19405344/offset=0&sort=priceAsc">Jackets</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Shorts & Skorts/c/19405343/offset=0&sort=priceAsc">Shorts & Skorts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=859#!/Caps-&-Headbands/c/19405342/offset=0&sort=priceAsc">Caps & Headbands</a></li>
	...
	<!--<div class="nav-column">
		    ...
		    <ul>
				...
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Shirts/c/19411719/offset=0&sort=priceAsc">Shirts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Sweatshirts/c/19411720/offset=0&sort=priceAsc">Sweatshirts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Shorts-&-Sweats/c/19411714/offset=0&sort=priceAsc">Shorts & Sweats</a></li> -->
				...
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Caps-&-Hats/c/19411713/offset=0&sort=priceAsc">Caps & Hats</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Scarves-&-Gloves/c/19411712/offset=0&sort=priceAsc">Scarves & Gloves</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Stadium Blankets/c/19411709/offset=0&sort=priceAsc">Stadium Blankets</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Backpacks-&-Bags/c/19411710/offset=0&sort=priceAsc">Backpacks & Bags</a></li>
		    ...
		    <ul>
		        <li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/All-Gameday-Colors/c/19411721/offset=0&sort=priceAsc">All Gameday Colors</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Tops/c/19411719/offset=0&sort=priceAsc">Shirts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Sweatshirts/c/19411720/offset=0&sort=priceAsc">Sweatshirts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Shorts-&-Sweats/c/19411714/offset=0&sort=priceAsc">Shorts & Sweats</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Caps-&-Hats/c/19411713/offset=0&sort=priceAsc">Caps & Hats</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=846#!/Scarves-&-Gloves/c/19411712/offset=0&sort=priceAsc">Scarves & Gloves</a></li> -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12  col-lg-3 vertical-divider col-flex-item" id="col_dropdown">
		<ul class="multi-column-dropdown">
			<span class="col-flex-item divider"></span>
			<li id="storename"><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Women's Activewear Depot/c/18159170/offset=0&sort=priceAsc">Women's<br>Activewear Depot</a></li>
		        <!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Best-Sellers-&-Bundle/c/18159181/offset=0&sort=priceAsc">Best Sellers & Bundles</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Active-Tops/c/19405389/offset=0&sort=priceAsc">Active Tops</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Tank-Tops/c/19405394/offset=0&sort=priceAsc">  Tanks</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Crew-Necks/c/19405393/offset=0&sort=priceAsc">	Crew Neck</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/V-Necks/c/19405392/offset=0&sort=priceAsc">	V Necks</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Performance/c/19405391/offset=0&sort=priceAsc">	Performance</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/All-Colors/c/19405390/offset=0&sort=priceAsc">	All Colors</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Active-Pants/c/19405395/offset=0&sort=priceAsc">Active Pants</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Active-Shorts/c/19405396/offset=0&sort=priceAsc">Active Shorts</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Active-Sweatshirts/c/19405397/offset=0&sort=priceAsc">Active Sweatshirts</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Hoodies/c/19405403/offset=0&sort=priceAsc">	Hoodies</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Front-Zip/c/19405402/offset=0&sort=priceAsc">	Front Zip</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Quarter-Zip/c/19405401/offset=0&sort=priceAsc">	Quarter Zip</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Crew-Necks/c/19405400/offset=0&sort=priceAsc">	Crew Neck</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/All-Colors/c/19405399/offset=0&sort=priceAsc">	All Colors</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Active-Outerwear/c/19405398/offset=0&sort=priceAsc">Active Outwear</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Jackets-&-Fleece/c/19405404/offset=0&sort=priceAsc">Jackets & Fleece</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Lounge-Wear/c/18159178/offset=0&sort=priceAsc">Lounge Wear</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Top-&-Bottom-Combo/c/19405406/offset=0&sort=priceAsc">	Top & Bottom Combo</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Caps-&-Hats/c/19405405/offset=0&sort=priceAsc">Caps & Hats</a></li>
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Bags-&-Accessories/c/19405407/offset=0&sort=priceAsc">Bags & Accessories</a></li>
				<!--<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/All-Natural-Apparel/c/19405408/offset=0&sort=priceAsc">All Natural Apparel</a></li> -->
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=858#!/Extended-Sizes/c/19405409/offset=0&sort=priceAsc">Extended Sizes</a></li>
	    </ul>
	</div> <!-- end column 2 -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12  col-lg-3 vertical-divider col-flex-item" id="col_dropdown">
		<ul class="multi-column-dropdown">
        	<span class="col-flex-item divider"></span>
        	<li id="storename"><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=902#!/Men's Activewear Depot/c/18159156/offset=0&sort=priceAsc">Men's<br>Activewear Depot</a></li>
				...
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=902#!/Jackets & Fleece/c/18159163/offset=0&sort=priceAsc">Jackets & Fleece</a></li>
	...
	<div class="col-xs-12 col-sm-12 col-md-12  col-lg-3" id="col_dropdown">
		<ul class="multi-column-dropdown">
			...
			<li id="storename"><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=925#!/Kids Activewear-Depot/c/18209055/offset=0&sort=priceAsc">Kid's<br>Activewear Depot</a></li>
				...
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=925#!/Active-Bottoms/c/20108022/offset=0&sort=priceAsc">Active Bottoms</a></li>
				...
				<li><a href="../greatmoodsMall.php?group=<?php echo $_GET['group']; ?>&storeid=925#!/Jackets/c/19963053/offset=0&sort=priceAsc">Jackets</a></li>
