...
<div id="container">
    ...
    <div id="content">
       ...
       <h3> FundraisingATM Representative Steps to $uccess</h3>
  		...
  		<p>Welcome.  As a FundraisingATM Sales Representative you will get to help your surrounding community reach their goals while earning a residual
  		...
  		<p>The Fundraising opportunities in your Community, State and Region are limitless and timeless. Every School, Church and Community
   		...
   		<p>Once you lockup your Free Fundraising Website accounts, you lockout the competition. First come, first serve.  Nobody is going to change
   		 from the FundraisingATM Free Fundraising Website Program once it is setup, as long as you support the fundraising leaders and we continue to
   		  update the products and software features. </p>
   		 <br>

		  <h3> FundraisingATM Representative Responsibility Summary<br>
	  	...
	  	<ul class="bulletedlist">
  			...
  			<li>Explain and Show them the FundraisingATM Free Online Program</li>
