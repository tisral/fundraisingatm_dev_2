       ...
       if(isset($_POST['submit']))
       {
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, gender, email, workPhone, ext,  address, apt, city, state, zip, fundMemberID,fundGroupID, image_path, repID, title, scID, vpID)VALUES('$fname', '$lname', '$cname', '$type', '$gd', '$email', '$phone', '$ext',  '$address1', '$address2', '$city','$state', '$zip', '$dealerID', '$groupID', '$personalPicPath', '$repID', '$tt', '', '$userID')";
...
<!DOCTYPE html>
<head>
	<title>Add Fundraising Contact</title>
