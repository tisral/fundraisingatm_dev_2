...
<!DOCTYPE html>
<head>
	<title> FundraisingATM Sales Representative Training Program Overview - A to Z </title>
</head>
...
<div id="container">
    ...
    <div id="content">
        ...
        <h3>FundraisingATM Sales Representative </h3>
	<div id>
	...
	<h5>First Step:</h5>
	<p>To begin as a FundraisingATM Representative Review the “Program Features” at www.FundraisingATM.com </p>
<ul>
	<ol>1)	Start by clicking on and reviewing each left navigation button on the Homepage at www.FundraisingATM.com, to understand the primary features of 		the FundraisingATM Fundraising Program.<br><br>
...
4)	Prioritize those Prospects into a top 10 to 20 list that you want to focus on first.<br>Click on one of the links to see an example of the High School Prospect List:
      ...
      5)Send in that list to your FundraisingATM Contact so we can create the Banners and you can start to research those Prospect Accounts for Contact Information, Pictures, Phone Numbers etc. <br><br>
