...
<div id="container">
	...
	<div id>
   		...
   		<h5>In-Person Appointment Presentation Checklist </h5>
	        ...
	        <li> 	Explain the FundraisingATM Fundraising Program and how it will address their needs. </li>
	        <li> 	When they say Yes, fill out the ‘Sign Up and Start Today’ page. This page can be found by clicking on the link entitled ‘$ign Up and $tart Today’ on the homepage of the FundraisingATM website. You’ll need to print this out. Who will be the Fundraising Leaders you should work with, etc. </li>
