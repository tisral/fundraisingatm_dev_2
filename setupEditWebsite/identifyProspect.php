...
<div id="container">
    ...
    <h3>Fundraising Account Opportunities in your Community or Region to Pursue Today!
      		...
      		<p>Let’s get started in identifying and setting up the specific Fundraising Accounts in your Region, that you would like to approach first with the FundraisingATM Program. After studying from the Prospect Opportunities page and Example Website section of the FundraisingATM website you should have a pretty good idea of whom your Prospects are, so now let’s start to target in on the specific Accounts you want to present to first in your Region.</p>
      		<p>Brainstorm some by either printing out one or all of the Prospect Forms below or create your own list to send to us. From the list you send us with the Account Name and Address, as well as the Accounts specific URL which we will create a real Website from; complete with the Prospective Accounts Banner posted at your own FundraisingATM Representative Website.  </p>
	...
	<p>The Reason we point this out is to show that Winter and Spring time have tremendous earning potential in addition to the Fall time. The FundraisingATM Mall has a wonderful selection of year round merchandise for every age, season or Fundraiser. </p>
	<p>If you already have Organizations or personal contacts in mind, feel free to start with those you already know and feel comfortable with.  FundraisingATM is here to help you find leads in your Community if you are unsure where to start.  There are always plenty of Prospect leads around in your region.  </p>
	<p> </p>
